...
objects = md_func.o utility.o nss.o md5.o name_buf.o xml.o bloom.o hash.o 
...
dedup_test : dedup_test.o md5.o hash.o bloom.o
	gcc dedup_test.o md5.o hash.o bloom.o -o dedup_test
.PHONY : clean
clean :
